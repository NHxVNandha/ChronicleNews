                ...
                <AdminPanel>
                  ...
                  <div className="mt-4 space-y-2">
                    {reviewQueue.map((article, index) => (
                      <div key={article.slug} className="transition hover:-translate-y-[2px]">
                        <AdminInfoCard
                ...
                <AdminPanel>
                  ...
                  <div className="mt-4 space-y-3">
                    {[
                      ...
                      <div key={`${item.day}-${item.slot}`} className="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50 p-3 transition hover:-translate-y-[2px]">
